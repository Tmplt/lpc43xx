...
pub enum SELECTR {
    ...
    #[doc = "MCOB2"]
    MCOB2,
    #[doc = "CTOUT_0 or T0_MAT0"]
    CTOUT_0_OR_T0_MAT0,
    #[doc = "CTOUT_8 or T2_MAT0"]
    CTOUT_8_OR_T2_MAT0,
    #[doc = "T0_MAT0"]
    T0_MAT0,
    #[doc = "T2_MAT0"]
...
impl SELECTR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            ...
            SELECTR::SGPIO12 => 3,
            SELECTR::MCOB2 => 5,
            SELECTR::CTOUT_0_OR_T0_MAT0 => 6,
            SELECTR::CTOUT_8_OR_T2_MAT0 => 7,
            SELECTR::T0_MAT0 => 8,
            SELECTR::T2_MAT0 => 9,
    ...
    pub fn _from(value: u8) -> SELECTR {
        match value {
            ...
            3 => SELECTR::SGPIO12,
            5 => SELECTR::MCOB2,
            6 => SELECTR::CTOUT_0_OR_T0_MAT0,
            7 => SELECTR::CTOUT_8_OR_T2_MAT0,
            8 => SELECTR::T0_MAT0,
            9 => SELECTR::T2_MAT0,
            i => SELECTR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `GPIO6_28`"]
    #[inline]
    pub fn is_gpio6_28(&self) -> bool {
        *self == SELECTR::GPIO6_28
    }
    #[doc = "Checks if the value of the field is `GPIO5_3`"]
    #[inline]
    pub fn is_gpio5_3(&self) -> bool {
        *self == SELECTR::GPIO5_3
    }
    #[doc = "Checks if the value of the field is `SGPIO10`"]
    #[inline]
    pub fn is_sgpio10(&self) -> bool {
        *self == SELECTR::SGPIO10
    }
    #[doc = "Checks if the value of the field is `SGPIO12`"]
    #[inline]
    pub fn is_sgpio12(&self) -> bool {
        *self == SELECTR::SGPIO12
    }
    ...
    #[doc = "Checks if the value of the field is `CTOUT_0_OR_T0_MAT0`"]
    #[inline]
    pub fn is_ctout_0_or_t0_mat0(&self) -> bool {
        *self == SELECTR::CTOUT_0_OR_T0_MAT0
    }
    #[doc = "Checks if the value of the field is `CTOUT_8_OR_T2_MAT0`"]
    #[inline]
    pub fn is_ctout_8_or_t2_mat0(&self) -> bool {
        *self == SELECTR::CTOUT_8_OR_T2_MAT0
    }
...
impl SELECTW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            ...
            SELECTW::SGPIO12 => 3,
            SELECTW::MCOB2 => 5,
            SELECTW::CTOUT_0_OR_T0_MAT0 => 6,
            SELECTW::CTOUT_8_OR_T2_MAT0 => 7,
            SELECTW::T0_MAT0 => 8,
            SELECTW::T2_MAT0 => 9,
        }
    }
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "GPIO6\\[28\\]"]
    #[inline]
    pub fn gpio6_28(self) -> &'a mut W {
        self.variant(SELECTW::GPIO6_28)
    }
    #[doc = "GPIO5\\[3\\]"]
    #[inline]
    pub fn gpio5_3(self) -> &'a mut W {
        self.variant(SELECTW::GPIO5_3)
    }
    #[doc = "SGPIO10"]
    #[inline]
    pub fn sgpio10(self) -> &'a mut W {
        self.variant(SELECTW::SGPIO10)
    }
    #[doc = "SGPIO12"]
    #[inline]
    pub fn sgpio12(self) -> &'a mut W {
        self.variant(SELECTW::SGPIO12)
    }
    #[doc = "MCOB2"]
    #[inline]
    pub fn mcob2(self) -> &'a mut W {
        self.variant(SELECTW::MCOB2)
    }
    #[doc = "CTOUT_0 or T0_MAT0"]
    #[inline]
    pub fn ctout_0_or_t0_mat0(self) -> &'a mut W {
        self.variant(SELECTW::CTOUT_0_OR_T0_MAT0)
    }
    #[doc = "CTOUT_8 or T2_MAT0"]
    #[inline]
    pub fn ctout_8_or_t2_mat0(self) -> &'a mut W {
        self.variant(SELECTW::CTOUT_8_OR_T2_MAT0)
    }
    #[doc = "T0_MAT0"]
    #[inline]
...
impl R {
    ...
    #[doc = "Bits 4:7 - Select input. Values 0xA to 0xF are reserved."]
    #[inline]
