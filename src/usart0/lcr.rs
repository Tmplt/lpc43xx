...
impl SBSR {
    ...
    #[doc = "Checks if the value of the field is `_2_STOP_BITS_1`"]
    #[inline]
    pub fn is_2_stop_bits_1(&self) -> bool {
        *self == SBSR::_2_STOP_BITS_1
    }
}
...
impl<'a> _SBSW<'a> {
    ...
    #[doc = "2 stop bits (1.5 if LCR\\[1:0\\]=00)."]
    #[inline]
    pub fn _2_stop_bits_1(self) -> &'a mut W {
        self.variant(SBSW::_2_STOP_BITS_1)
    }
