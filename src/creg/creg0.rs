...
pub enum WAKEUP0CTRLR {
    ...
    INPUT_TO_THE_EVENT_ROUTER_NULL,
    #[doc = "Output from the event router."]
    OUTPUT_FROM_THE_EVEN,
    #[doc = "Input to the event router."]
    INPUT_TO_THE_EVENT_ROUTER,
}
impl WAKEUP0CTRLR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bits(&self) -> u8 {
        match *self {
            WAKEUP0CTRLR::INPUT_TO_THE_EVENT_ROUTER_NULL => 0,
            WAKEUP0CTRLR::OUTPUT_FROM_THE_EVEN => 1,
            WAKEUP0CTRLR::INPUT_TO_THE_EVENT_ROUTER => 3,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: u8) -> WAKEUP0CTRLR {
        match value {
            0 => WAKEUP0CTRLR::INPUT_TO_THE_EVENT_ROUTER_NULL,
            1 => WAKEUP0CTRLR::OUTPUT_FROM_THE_EVEN,
            3 => WAKEUP0CTRLR::INPUT_TO_THE_EVENT_ROUTER,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `INPUT_TO_THE_EVENT_ROUTER_NULL`"]
    #[inline]
    pub fn is_input_to_the_event_router_null(&self) -> bool {
        *self == WAKEUP0CTRLR::INPUT_TO_THE_EVENT_ROUTER_NULL
    }
    #[doc = "Checks if the value of the field is `OUTPUT_FROM_THE_EVEN`"]
    #[inline]
    pub fn is_output_from_the_even(&self) -> bool {
    ...
    #[doc = "Checks if the value of the field is `INPUT_TO_THE_EVENT_ROUTER`"]
    #[inline]
    pub fn is_input_to_the_event_router(&self) -> bool {
        *self == WAKEUP0CTRLR::INPUT_TO_THE_EVENT_ROUTER
    }
}
...
pub enum WAKEUP1CTRLR {
    ...
    INPUT_TO_EVENT_ROUTER_NULL,
    #[doc = "Output from the event router."]
    OUTPUT_FROM_THE_EVENT_ROUTER,
    #[doc = "Input to event router."]
    INPUT_TO_EVENT_ROUTER,
}
impl WAKEUP1CTRLR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bits(&self) -> u8 {
        match *self {
            WAKEUP1CTRLR::INPUT_TO_EVENT_ROUTER_NULL => 0,
            WAKEUP1CTRLR::OUTPUT_FROM_THE_EVENT_ROUTER => 1,
            WAKEUP1CTRLR::INPUT_TO_EVENT_ROUTER => 3,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: u8) -> WAKEUP1CTRLR {
        match value {
            0 => WAKEUP1CTRLR::INPUT_TO_EVENT_ROUTER_NULL,
            1 => WAKEUP1CTRLR::OUTPUT_FROM_THE_EVENT_ROUTER,
            3 => WAKEUP1CTRLR::INPUT_TO_EVENT_ROUTER,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `INPUT_TO_EVENT_ROUTER_NULL`"]
    #[inline]
    pub fn is_input_to_event_router_null(&self) -> bool {
        *self == WAKEUP1CTRLR::INPUT_TO_EVENT_ROUTER_NULL
    }
    #[doc = "Checks if the value of the field is `OUTPUT_FROM_THE_EVENT_ROUTER`"]
    #[inline]
    pub fn is_output_from_the_event_router(&self) -> bool {
        *self == WAKEUP1CTRLR::OUTPUT_FROM_THE_EVENT_ROUTER
    }
    #[doc = "Checks if the value of the field is `INPUT_TO_EVENT_ROUTER`"]
    #[inline]
    pub fn is_input_to_event_router(&self) -> bool {
        *self == WAKEUP1CTRLR::INPUT_TO_EVENT_ROUTER
    }
}
...
impl WAKEUP0CTRLW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            WAKEUP0CTRLW::INPUT_TO_THE_EVENT_ROUTER_NULL => 0,
            WAKEUP0CTRLW::OUTPUT_FROM_THE_EVEN => 1,
            WAKEUP0CTRLW::INPUT_TO_THE_EVENT_ROUTER => 3,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _WAKEUP0CTRLW<'a> {
    ...
    #[doc = "Input to the event router."]
    #[inline]
    pub fn input_to_the_event_router_null(self) -> &'a mut W {
        self.variant(WAKEUP0CTRLW::INPUT_TO_THE_EVENT_ROUTER_NULL)
    }
    #[doc = "Output from the event router."]
    #[inline]
    pub fn output_from_the_even(self) -> &'a mut W {
    ...
    #[doc = "Input to the event router."]
    #[inline]
    pub fn input_to_the_event_router(self) -> &'a mut W {
        self.variant(WAKEUP0CTRLW::INPUT_TO_THE_EVENT_ROUTER)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl WAKEUP1CTRLW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            WAKEUP1CTRLW::INPUT_TO_EVENT_ROUTER_NULL => 0,
            WAKEUP1CTRLW::OUTPUT_FROM_THE_EVENT_ROUTER => 1,
            WAKEUP1CTRLW::INPUT_TO_EVENT_ROUTER => 3,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _WAKEUP1CTRLW<'a> {
    ...
    #[doc = "Input to event router."]
    #[inline]
    pub fn input_to_event_router_null(self) -> &'a mut W {
        self.variant(WAKEUP1CTRLW::INPUT_TO_EVENT_ROUTER_NULL)
    }
    #[doc = "Output from the event router."]
    #[inline]
    pub fn output_from_the_event_router(self) -> &'a mut W {
        self.variant(WAKEUP1CTRLW::OUTPUT_FROM_THE_EVENT_ROUTER)
    }
    #[doc = "Input to event router."]
    #[inline]
    pub fn input_to_event_router(self) -> &'a mut W {
        self.variant(WAKEUP1CTRLW::INPUT_TO_EVENT_ROUTER)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
