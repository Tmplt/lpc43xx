...
pub enum BIR {
    ...
    BREAK_INTERRUPT_STATUS_INACTIVE,
    #[doc = "Break interrupt status is active."]
    BREAK_INTERRUPT_STATUS_ACTIVE,
}
impl BIR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    ...
    pub fn bit(&self) -> bool {
        match *self {
            BIR::BREAK_INTERRUPT_STATUS_INACTIVE => false,
            BIR::BREAK_INTERRUPT_STATUS_ACTIVE => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> BIR {
        match value {
            false => BIR::BREAK_INTERRUPT_STATUS_INACTIVE,
            true => BIR::BREAK_INTERRUPT_STATUS_ACTIVE,
        }
    }
    #[doc = "Checks if the value of the field is `BREAK_INTERRUPT_STATUS_INACTIVE`"]
    #[inline]
    pub fn is_break_interrupt_status_inactive(&self) -> bool {
        *self == BIR::BREAK_INTERRUPT_STATUS_INACTIVE
    }
    #[doc = "Checks if the value of the field is `BREAK_INTERRUPT_STATUS_ACTIVE`"]
    #[inline]
    pub fn is_break_interrupt_status_active(&self) -> bool {
        *self == BIR::BREAK_INTERRUPT_STATUS_ACTIVE
    }
}
